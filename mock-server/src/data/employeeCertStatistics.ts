...
const baseStatsByDept: Record<string, DepartmentCertStatistic[]> = {
  '0': [
    { deptCode: 'dept-ict-core-ops', deptName: '云核心网运营部', totalCount: 320, certifiedCount: 208, certRate: 65 },
    { deptCode: 'dept-ict-core-dev', deptName: '云核心网研发部', totalCount: 280, certifiedCount: 190, certRate: 67.86 },
    { deptCode: 'dept-ict-core-solution', deptName: '云核心网解决方案部', totalCount: 240, certifiedCount: 168, certRate: 70 },
  ],
  'dept-ict-core-ops': [
    { deptCode: 'dept-ict-core-ops-asia', deptName: '亚太运营支撑处', totalCount: 140, certifiedCount: 96, certRate: 68.57 },
    { deptCode: 'dept-ict-core-ops-emea', deptName: '欧洲中东非运营支撑处', totalCount: 110, certifiedCount: 70, certRate: 63.64 },
  ],
  'dept-ict-core-dev': [
    { deptCode: 'dept-ict-core-dev-platform', deptName: '网络云平台研发室', totalCount: 150, certifiedCount: 108, certRate: 72 },
    { deptCode: 'dept-ict-core-dev-ai', deptName: 'AI 网络创新室', totalCount: 120, certifiedCount: 84, certRate: 70 },
  ],
  'dept-ict-core-solution': [
    { deptCode: 'dept-ict-core-solution-5g', deptName: '5G 解决方案办', totalCount: 130, certifiedCount: 86, certRate: 66.15 },
    { deptCode: 'dept-ict-core-solution-cloud', deptName: '云化核心网方案办', totalCount: 110, certifiedCount: 78, certRate: 70.91 },
  ],
}
